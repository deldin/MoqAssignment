...
{
    public class Export814XmlDataAccess : IMarket814Export
    {
        private readonly string connectionString;

        public Export814XmlDataAccess(string connectionString)
        {
        ...
        {
            using (var connection = new SqlConnection(connectionString))
            using (var command = connection.CreateCommand("esp_814ServiceList"))
            {
                command.AddWithValue("@HeaderKey", headerKey);
        ...
        /// <summary>
        /// Xml exports Meter Changes by Meter Key
        /// </summary>
        ...
        {
            using (var connection = new SqlConnection(connectionString))
            using (var command = connection.CreateCommand("esp_814HeaderStatusUpdate"))
            {
                command.AddWithValue("@HeaderKey", headerKey)
