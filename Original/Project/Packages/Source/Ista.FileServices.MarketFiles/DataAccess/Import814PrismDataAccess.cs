...
{
    public class Import814PrismDataAccess : IMarket814Import
    {
        private readonly string connectionString;

        public Import814PrismDataAccess(string connectionString)
        {
        ...
        public int InsertService(Type814Service model)
        {
            ...
            using (var command = connection.CreateCommand("csp814ServiceInsert"))
            {
                ...
                command.AddWithValue("@814_Key", model.HeaderKey)
                    ...
                    .AddWithValue("@ESPChargesResTaxRate", model.EspChargesResTaxRate)
                    ...
                    .AddWithValue("@ReinstatementDate", model.ReinstatementDate)
                    ...
                    .AddWithValue("@UnmeteredAcct", model.UnmeteredAcct)
                    .AddWithValue("@POLRClass", model.PolrClass)
                    ...
                    .AddWithValue("@MeterAccessNote", model.MeterAccessNote)
                    .AddWithValue("@SpecialNeedsIndicator", model.SpecialNeedsIndicator)
                    .AddWithValue("@SpecialNeedsExpirationDate", model.SpecialNeedsExpirationDate)
                    .AddWithValue("@SwitchHoldStatusIndicator", model.SwitchHoldStatusIndicator)
        ...
        public int InsertServiceMeter(Type814ServiceMeter model)
        {
            ...
            using (var command = connection.CreateCommand("csp814ServiceMeterInsert"))
            {
                ...
                command.AddWithValue("@Service_Key", model.ServiceKey)
                    ...
                    .AddWithValue("@AMSIndicator", model.AmsIndicator)
