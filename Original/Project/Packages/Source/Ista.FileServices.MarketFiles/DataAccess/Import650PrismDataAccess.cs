...
{
    public class Import650PrismDataAccess : IMarket650Import
    {
        private readonly string connectionString;

        public Import650PrismDataAccess(string connectionString)
        {
        ...
        public int InsertService(Type650Service model)
        {
            ...
            using (var command = connection.CreateCommand("csp650ServiceInsert"))
            {
                ...
                command.AddWithValue("@650_Key", model.HeaderKey)
                    ...
                    .AddWithValue("@PremiseTypeVerification", model.PremiseTypeVerification)
                    .AddWithValue("@PremiseTypeDesc", model.PremiseTypeDesc)
                    .AddWithValue("@SwitchHoldIndicator", model.SwitchHoldIndicator)
                    .AddWithValue("@SwitchHoldDesc", model.SwitchHoldDesc)
