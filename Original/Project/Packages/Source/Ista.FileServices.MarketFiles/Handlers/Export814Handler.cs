...
{
    public class Export814Handler : IExportTransactionHandler
    {
        private readonly ILogger logger;
        private readonly IMarket814Export marketDataAccess;

        public Export814Handler(IMarket814Export marketDataAccess, ILogger logger)
        {
        ...
        public void UpdateHeader(int headerKey, int marketFileId, string fileName)
        {
            ...
            logger.DebugFormat("Updated 814 Header {0} with Market File Id {1}", headerKey, marketFileId);
        }
