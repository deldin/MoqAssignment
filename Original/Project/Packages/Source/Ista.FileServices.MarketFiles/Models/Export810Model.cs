...
{
    public class Export810Model : IMarketFileExportResult
    {
        ...
        public Export810Model(bool forXmlContent)
            : this()
        {
        ...
        public string GenerateFileName(string fileType, string fileExtension)
        {
            if (!string.IsNullOrWhiteSpace(FileNamePrefix))
                fileType = string.Concat(FileNamePrefix, "_", fileType);
