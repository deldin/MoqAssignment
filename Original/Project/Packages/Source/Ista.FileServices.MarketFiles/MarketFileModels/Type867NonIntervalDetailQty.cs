...
{
    public class Type867NonIntervalDetailQty : IType867Model
    {
        public Type867Types ModelType
        {
            get { return Type867Types.NonIntervalDetailQty; }
        }
        ...
        public Type867NonIntervalDetailQtyStatus Status { get; set; }
    }
}