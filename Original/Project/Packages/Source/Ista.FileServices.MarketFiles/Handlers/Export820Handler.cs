...
{
    public class Export820Handler : IExportTransactionHandler
    {
        private readonly ILogger logger;
        private readonly IMarket820Export marketDataAccess;

        public Export820Handler(IMarket820Export marketDataAccess, ILogger logger)
        {
        ...
        public void UpdateHeader(int headerKey, int marketFileId, string fileName)
        {
            ...
            logger.DebugFormat("Updated 820 Header {0} with Market File Id {1}", headerKey, marketFileId);
        }
